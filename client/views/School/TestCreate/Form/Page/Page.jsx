...
// View
import SchoolTestCreateFormPageCreate from './Create.jsx';
import SchoolTestCreateFormPageShow from './Show.jsx';

const SchoolTestCreateFormPage = React.createClass({
        ...
        <div className='ui grid'>
          ...
          <div className='row'>
            <div className='sixteen wide column'>
              <SchoolTestCreateFormPageCreate
...
export default SchoolTestCreateFormPage;
