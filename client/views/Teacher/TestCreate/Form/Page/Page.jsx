...
// View
import TeacherTestCreateFormPageCreate from './Create.jsx';
import TeacherTestCreateFormPageShow from './Show.jsx';

const TeacherTestCreateFormPage = React.createClass({
        ...
        <div className='ui grid'>
          ...
          <div className='row'>
            <div className='sixteen wide column'>
              <TeacherTestCreateFormPageCreate
...
export default TeacherTestCreateFormPage;
