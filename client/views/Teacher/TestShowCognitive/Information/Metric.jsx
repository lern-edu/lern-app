...
TeacherTestShowCognitiveMetrics = React.createClass({
  ...
  render() {
    ...
    return (
      <div style={{ marginTop: '1.5em' }}>
        <TeacherTestShowCognitiveMetricsToolbar {...this.props} options={options}/>
        ...
        <Paper>
          <div style={{ padding: '1em' }}>
            ...
            <div className='row'>
              {JSON.parse(chart)
                ? <TeacherTestShowCognitiveInfoChart {...this.props} />
                : <TeacherTestShowCognitiveInfoTable {...this.props} options={options} />}
            </div>
