...
// Views
import TeacherPostCreateFormBasic from './Basic/index.jsx';
import TeacherPostCreateFormTheme from './Theme/Container.jsx';

const TeacherPostCreateForm = React.createClass({
  ...
  */
  ...
  handleSubmitSuccess({ _id: postId, course }) {
    ...
    snack('Post criado');
    course
    ? FlowRouter.go('TeacherCourseShow', { courseId: course }, { active: 'posts' })
    : FlowRouter.go('TeacherPosts');
  },
...
export default TeacherPostCreateForm;
