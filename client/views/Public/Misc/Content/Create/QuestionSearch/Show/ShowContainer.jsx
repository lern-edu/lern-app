...
// View
import PublicContentCreateQuestionSearchShowView from './Show.jsx';

export default PublicContentCreateQuestionSearchShow =
  createContainer((params) => {
    ...
    return data;
  }, PublicContentCreateQuestionSearchShowView);
