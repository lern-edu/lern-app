...
// View
import AdminTestCreateFormPageCreateContentShowQuestionView from './Question.jsx';

export default AdminTestCreateFormPageCreateContentShowQuestion =
  createContainer(({ questionId }) => {
    ...
    return data;
  }, AdminTestCreateFormPageCreateContentShowQuestionView);
