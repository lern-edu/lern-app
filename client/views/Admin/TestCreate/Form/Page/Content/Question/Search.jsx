...
// Views
import AdminTestCreateFormPageQuestionSearchTags from './TagsContainer.jsx';
import AdminTestCreateFormPageQuestionSearchShow from './Show/ShowContainer.jsx';

const AdminTestCreateFormPageQuestionSearch = React.createClass({
    ...
    return (
      <Dialog
        ...
        <div className='ui center aligned grid' >
          ...
          <div {...this.column} >
            <AdminTestCreateFormPageQuestionSearchTags
              parent={this}
              tagText={tagText}
              subjects={subjects}
              subject={subjectId}
          ...
          <div className='row'>
            <AdminTestCreateFormPageQuestionSearchShow
...
export default AdminTestCreateFormPageQuestionSearch;
